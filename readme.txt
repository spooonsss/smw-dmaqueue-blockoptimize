...
Patch optimize_block_change.asm to your ROM. You likely won't need to change the default ram addresses, but if they conflict with something, you can. If you just want to use this patch to optimize the block change, then you can stop reading here.
